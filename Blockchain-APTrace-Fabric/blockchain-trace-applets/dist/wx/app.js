...
var fly = new Fly();
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.prototype.$httpBlock = fly;
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.prototype.$httpUrl = "http://8.130.41.252:8080/route";
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-10b6f76d", Component.options)
  } else {
    hotAPI.reload("data-v-10b6f76d", Component.options)
  }
